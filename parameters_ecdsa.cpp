...
namespace {
    ...
    )
    {
        ...
        // a random-number generator for testing keys
        CryptoPP::AutoSeededRandomPool prng;

        // validate that we have a correct curve point
        if (!secretKey.Validate(prng, 3)) {
            // the key point generated by libsodium is not a valid ecdsa curve point
            throw std::invalid_argument{ "ECDSA key is invalid" };
        }
